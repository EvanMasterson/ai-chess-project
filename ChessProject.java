...
public class ChessProject extends JFrame implements MouseListener, MouseMotionListener {
    ...
    */
    ...
    /*
      Method to check were the White Pawn can move to. There are two main conditions here. Either the White Pawn is in
    ...
    */
    ...
    private Stack getWhitePawnMoves(int x, int y, String piece) {
        ...
        if(startingSquare.getYC() == 1){
            ...
            //First move only
            if(!piecePresent(((tmp1.getXC() * 75) + 20), (((tmp1.getYC() * 75) + 20))) && !piecePresent(((tmp2.getXC() * 75) + 20), (((tmp2.getYC() * 75) + 20)))){
                moves.push(validM);
                moves.push(validM2);
            }
    ...
    /*
      The getKingMoves method takes as an input any coordinates from a square and returns a stack of all the possible
...
*/
    ...
    */
            ...
            if (checkSurroundingSquares(tmp)) {
                ...
                if (!piecePresent(((tmp.getXC() * 75) + 20), (((tmp.getYC() * 75) + 20)))) {
                    if(checkKingDanger(((tmp.getXC() * 75)), (((tmp.getYC() * 75))), piece)) {
                        moves.push(validM);
                    }
                } else {
            ...
            if (!(tmpy1 > 7)) {
                if (checkSurroundingSquares(tmp1)) {
                    ...
                    if (!piecePresent(((tmp1.getXC() * 75) + 20), (((tmp1.getYC() * 75) + 20)))) {
                        if(checkKingDanger(((tmp1.getXC() * 75)), (((tmp1.getYC() * 75))), piece)) {
                            moves.push(validM2);
                        }
                    } else {
            ...
            if (!(tmpy2 < 0)) {
                if (checkSurroundingSquares(tmp2)) {
                    ...
                    if (!piecePresent(((tmp2.getXC() * 75) + 20), (((tmp2.getYC() * 75) + 20)))) {
                        if(checkKingDanger(((tmp2.getXC() * 75)), (((tmp2.getYC() * 75))), piece)) {
                            moves.push(validM3);
                        }
                    } else {
        ...
        if (!((tmpx2 < 0))) {
            ...
            if (checkSurroundingSquares(tmp3)) {
                ...
                if (!piecePresent(((tmp3.getXC() * 75) + 20), (((tmp3.getYC() * 75) + 20)))) {
                    if(checkKingDanger(((tmp3.getXC() * 75)), (((tmp3.getYC() * 75))), piece)) {
                        moves.push(validM);
                    }
                } else {
                    if (checkWhiteOpponent(((tmp3.getXC() * 75) + 20), (((tmp3.getYC() * 75) + 20)))) {
            ...
            if (!(tmpy1 > 7)) {
                if (checkSurroundingSquares(tmp4)) {
                    ...
                    if (!piecePresent(((tmp4.getXC() * 75) + 20), (((tmp4.getYC() * 75) + 20)))) {
                        if(checkKingDanger(((tmp4.getXC() * 75)), (((tmp4.getYC() * 75))), piece)) {
                            moves.push(validM2);
                        }
                    } else {
                        if (checkWhiteOpponent(((tmp4.getXC() * 75) + 20), (((tmp4.getYC() * 75) + 20)))) {
            ...
            if (!(tmpy2 < 0)) {
                if (checkSurroundingSquares(tmp5)) {
                    ...
                    if (!piecePresent(((tmp5.getXC() * 75) + 20), (((tmp5.getYC() * 75) + 20)))) {
                        if(checkKingDanger(((tmp5.getXC() * 75)), (((tmp5.getYC() * 75))), piece)) {
                            moves.push(validM3);
                        }
                    } else {
        ...
        if (!(tmpy1 > 7)) {
            if (checkSurroundingSquares(tmp7)) {
                ...
                if (!piecePresent(((tmp7.getXC() * 75) + 20), (((tmp7.getYC() * 75) + 20)))) {
                    if(checkKingDanger(((tmp7.getXC() * 75)), (((tmp7.getYC() * 75))), piece)) {
                        moves.push(validM2);
                    }
                } else {
        ...
        if (!(tmpy2 < 0)) {
            if (checkSurroundingSquares(tmp8)) {
                ...
                if (!piecePresent(((tmp8.getXC() * 75) + 20), (((tmp8.getYC() * 75) + 20)))) {
                    if(checkKingDanger(((tmp8.getXC() * 75)), (((tmp8.getYC() * 75))), piece)) {
                        moves.push(validM3);
                    }
                } else {
            ...
            if (!(tmpx1 > 7 || tmpx1 < 0)) {
                ...
                if (!piecePresent(((tmp2.getXC() * 75) + 20), (((tmp2.getYC() * 75) + 20)))) {
                    ...
                    if (piece.contains("White")) {
                        ...
                        if (checkBlackOpponent(((tmp2.getXC() * 75) + 20), ((tmp2.getYC() * 75) + 20))) {
                            moves.push(validM2);
                            break;
                        } else {
                            break;
            ...
            if (!(tmpy3 > 7 || tmpy3 < 0)) {
                ...
                if (!piecePresent(((tmp3.getXC() * 75) + 20), (((tmp3.getYC() * 75) + 20)))) {
                    ...
                    if (piece.contains("White")) {
                        ...
                        if (checkBlackOpponent(((tmp3.getXC() * 75) + 20), ((tmp3.getYC() * 75) + 20))) {
                            moves.push(validM3);
                            break;
                        } else {
                            break;
            ...
            if (!(tmpy4 > 7 || tmpy4 < 0)) {
                ...
                if (!piecePresent(((tmp4.getXC() * 75) + 20), (((tmp4.getYC() * 75) + 20)))) {
                    ...
                    if (piece.contains("White")) {
                        ...
                        if (checkBlackOpponent(((tmp4.getXC() * 75) + 20), ((tmp4.getYC() * 75) + 20))) {
                            moves.push(validM4);
                            break;
                        } else {
                            break;
  ...
  */
            ...
            if (!(tmpk > 7 || tmpk < 0 || tmpy2 > 7 || tmpy2 < 0)) {
                ...
                if (!piecePresent(((tmpK1.getXC() * 75) + 20), (((tmpK1.getYC() * 75) + 20)))) {
                    ...
                    if (piece.contains("White")) {
                        ...
                        if (checkBlackOpponent(((tmpK1.getXC() * 75) + 20), ((tmpK1.getYC() * 75) + 20))) {
                            moves.push(validM2);
                            break;
                        } else {
                            break;
            ...
            if (!(tmpL2 > 7 || tmpL2 < 0 || tmpy3 > 7 || tmpy3 < 0)) {
                ...
                if (!piecePresent(((tmpLMov2.getXC() * 75) + 20), (((tmpLMov2.getYC() * 75) + 20)))) {
                    ...
                    if (piece.contains("White")) {
                        ...
                        if (checkBlackOpponent(((tmpLMov2.getXC() * 75) + 20), ((tmpLMov2.getYC() * 75) + 20))) {
                            moves.push(validM3);
                            break;
                        } else {
                            break;
            ...
            if (!(tmpN2 > 7 || tmpN2 < 0 || tmpy4 > 7 || tmpy4 < 0)) {
                ...
                if (!piecePresent(((tmpNmov2.getXC() * 75) + 20), (((tmpNmov2.getYC() * 75) + 20)))) {
                    ...
                    if (piece.contains("White")) {
                        ...
                        if (checkBlackOpponent(((tmpNmov2.getXC() * 75) + 20), ((tmpNmov2.getYC() * 75) + 20))) {
                            moves.push(validM4);
                            break;
                        } else {
                            break;
    ...
    */
    ...
    private void colorSquaresBlack(Stack squares) {
        Border greenBorder = BorderFactory.createLineBorder(Color.BLUE, 3);
        while (!squares.empty()) {
            Square s = (Square) squares.pop();
            int location = s.getXC() + ((s.getYC()) * 8);
            JPanel panel = (JPanel) chessBoard.getComponent(location);
    ...
    */
    ...
    private void getLandingSquaresBlack(Stack found) {
        Move tmp;
        Square landing;
        Stack squares = new Stack();
        while (!found.empty()) {
    ...
    private Stack findWhitePieces() {
        ...
        for (int i = 0; i < 600; i += 75) {
            for (int j = 0; j < 600; j += 75) {
                y = i / 75;
                x = j / 75;
                String piece = getPieceName(j,i);
                if(piece.contains("White")){
                    pieceName = piece.substring(0, piece.length()-4);
   ...
   */
    ...
    /*
        Method to find all squares White can move to
     */
    private Stack getWhiteAttackingSquares(Stack pieces) {
        ...
        while (!pieces.empty()) {
            ...
            if (tmpString.contains("Knight")) {
                temp = getKnightMoves(s.getXC(), s.getYC(), s.getName());
                while (!temp.empty()) {
                    Move tempKnight = (Move) temp.pop();
                    squares.push(tempKnight);
                }
            } else if (tmpString.contains("Bishop")) {
                temp = getBishopMoves(s.getXC(), s.getYC(), s.getName());
                while (!temp.empty()) {
                    Move tempBishop = (Move) temp.pop();
                    squares.push(tempBishop);
                }
            } else if (tmpString.contains("Rook")) {
                temp = getRookMoves(s.getXC(), s.getYC(), s.getName());
                while (!temp.empty()) {
                    Move tempRook = (Move) temp.pop();
                    squares.push(tempRook);
                }
            } else if (tmpString.contains("Queen")) {
                temp = getQueenMoves(s.getXC(), s.getYC(), s.getName());
                while (!temp.empty()) {
                    Move tempQueen = (Move) temp.pop();
                    squares.push(tempQueen);
                }
            } else if (tmpString.contains("King")) {
                temp = getKingMoves(s.getXC(), s.getYC(), s.getName());
                while (!temp.empty()) {
                    Move tempKing = (Move) temp.pop();
                    squares.push(tempKing);
                }
            } else if (tmpString.contains("Pawn")) {
                temp = getWhitePawnMoves(s.getXC(), s.getYC(), s.getName());
                while (!temp.empty()) {
                    Move tempPawn = (Move) temp.pop();
                    squares.push(tempPawn);
                }
            }
        }
        return squares;
    ...
    /*
        Method to find all squares Black can move to
     */
    private Stack getBlackAttackingSquares(Stack pieces) {
        Stack squares = new Stack();
        Stack temp;
        ...
        while (!pieces.empty()) {
            ...
            if (tmpString.contains("Knight")) {
                ...
                temp = getBlackPawnMoves(s.getXC(), s.getYC(), s.getName());
                while (!temp.empty()) {
                    Move tempPawn = (Move) temp.pop();
                    squares.push(tempPawn);
                }
    ...
    /*
        This method allows you to place a specified piece on a location on the board
     */
    private void placePiece(int x, int y, String pieceName){
        resetBorders();
    ...
    /*
        This method allows you to remove a piece at a specified location
     */
    ...
    /*
        Method to check when moving the Black King if he is moving into check or not
        It changes the state of the board and evaluates if the king will get taken or not
        It then reverts the changes and our King will either have a validmove or not
     */
    private Boolean checkKingDanger(int x, int y, String piece){
        resetBorders();
        layeredPane.validate();
        layeredPane.repaint();
        Boolean move = true;
        ...
        if (piece.contains("White")){
            Stack pieceStackBlack = findBlackPieces();
            Stack attackingSquaresBlack = getBlackAttackingSquares(pieceStackBlack);
            if(pieceName.contains("White")){
                ...
                Stack tempAttackingSquares = (Stack) attackingSquaresBlack.clone();
                System.out.println(tempAttackingSquares.size());

                removePiece(x,y);
                placePiece(x,y,pieceName);

                while (!tempAttackingSquares.empty()){
                    Move m = (Move) tempAttackingSquares.pop();
                    Square s = (Square) m.getLanding();
                    System.out.println(s.getXC() + ","+s.getYC() + ","+s.getName()+","+x/75 + ","+y/75);
            ...
            if(pieceName.contains("White")) {
                ...
                Stack pieceStackWhite = findWhitePieces();
                Stack attackingSquaresWhite = getWhiteAttackingSquares(pieceStackWhite);

                while (!attackingSquaresWhite.empty()){
                    Move m = (Move) attackingSquaresWhite.pop();
                    Square s = (Square) m.getLanding();
                    System.out.println(s.getXC() + ","+s.getYC() + ","+x/75 + ","+y/75);
                    if((s.getXC() == x/75) &&(s.getYC() == y/75)){
                        System.out.println("You can't move into Check!");
                        removePiece(x,y);
                        placePiece(x,y,pieceName);
                ...
                Stack pieceStackWhite = findWhitePieces();
                Stack attackingSquaresWhite = getWhiteAttackingSquares(pieceStackWhite);
                System.out.println(attackingSquaresWhite.size());
    ...
    */
        ...
        Stack completeMovesWhite = getWhiteAttackingSquares(white);

        Stack black = findBlackPieces();
        Stack completeMovesBlack = getBlackAttackingSquares(black);

        temporary = (Stack) completeMovesWhite.clone();
...
*/
    ...
    */
            System.out.println("=============================================================");
            Stack randomMove = new Stack();
            Stack nextBestMove = new Stack();
            Stack twoLevelsDeep = new Stack();
            List pieceName = new ArrayList();
            ...
            while (!completeMovesWhite.empty()) {
                ...
                String piece = getPieceName(((s2.getXC()*75) + 20), ((s2.getYC()*75) + 20));

                randomMove.push(tmpMove);

                if(getPieceName(((s2.getXC()*75) + 20), ((s2.getYC()*75) + 20)).contains("Black")){
                    pieceName.add(piece);
                    nextBestMove.push(tmpMove);
                } else if ((s2.getXC() == 3 && s2.getYC() ==3) || (s2.getXC() == 3 && s2.getYC() ==4) || (s2.getXC() == 4 && s2.getYC() ==3) || (s2.getXC() == 4 && s2.getYC() ==4)){
                    pieceName.add(piece);
                    nextBestMove.push(tmpMove);
                }
            }
            ...
            if(choice == 0){
                selectedMove = agent.randomMove(randomMove);
                System.out.println("Random Move");
            }
            else if(choice == 1) {
                if(nextBestMove.size() > 0) {
                    selectedMove = agent.nextBestMove(nextBestMove, pieceName);
                    System.out.println("Next Best Move");
                } else {
                    selectedMove = agent.randomMove(randomMove);
                    System.out.println("Couldn't find best move, chose random move");
                }
            }
            else if(choice == 2){
                if(nextBestMove.size() > 0) {
                    selectedMove = agent.twoLevelsDeep(nextBestMove, pieceName);
                    System.out.println("Two Levels Deep Move");
                } else {
                    selectedMove = agent.randomMove(randomMove);
                    System.out.println("Couldn't find best move, chose random move");
                }
            ...
            if (l instanceof JLabel) {
                ...
                if (agentwins) {
                    ...
                    System.exit(0);
                } else if(landingPoint.getYC() == 7 && landingPoint.getName().contains("WhitePawn")) {
                    pieces = new JLabel(new ImageIcon("WhiteQueen.png"));
                    int landingPanelID = (landingPoint.getYC() * 8) + landingPoint.getXC();
                    panels = (JPanel) chessBoard.getComponent(landingPanelID);
                    panels.add(pieces);
                ...
                if(landingPoint.getYC() == 7 && landingPoint.getName().contains("WhitePawn")) {
                    pieces = new JLabel(new ImageIcon("WhiteQueen.png"));
                    int landingPanelID = (landingPoint.getYC() * 8) + landingPoint.getXC();
                    panels = (JPanel) chessBoard.getComponent(landingPanelID);
                    panels.add(pieces);
        ...
        */
                  ...
                  */
                                if (piecePresent(e.getX(), e.getY())) {
                                    if (pieceName.contains("White")) {
                                        ...
                                        if (checkBlackOpponent(e.getX(), e.getY())) {
                                            if (checkKingDanger(e.getX(), e.getY(), pieceName)) {
                                                validMove = true;
                                            }
                                        }
                                    }
        ...
        if (!validMove) {
            ...
            if (progression) {
                ...
                if (!pieceName.contains("BlackKing") && c instanceof JLabel) {
                    Container parent = c.getParent();
                    parent.remove(0);
